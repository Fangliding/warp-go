...
func (device *Device) AddAllowedIPs(prefix netip.Prefix, peer *Peer) {
...
func (device *Device) SetReserved(reserved [3]byte) error {
	device.net.reserved = reserved
	device.cookieChecker.Init(device.staticIdentity.publicKey, reserved)
	return nil
}
...
func (device *Device) SetPrivateKey(sk NoisePrivateKey) error {
	...
	device.cookieChecker.Init(publicKey, device.net.reserved)
...
func NewDevice(tunDevice tun.Device, bind conn.Bind, logger *Logger) *Device {
	...
	device.log = logger
	device.net.reserved = [3]byte{0, 0, 0}
